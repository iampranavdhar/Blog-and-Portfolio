    ...
    return (
        <div className="home" id='home'>
            ...
            <div className="home-social">
                <a href="https://www.linkedin.com/in/sai-pranavdhar-reddy-nalamalapu-038104206/" className="home-social-icon">
                    <LinkedInIcon className='icon' />
                </a>
                <a href="https://twitter.com/Pranavdhar8" className="home-social-icon">
